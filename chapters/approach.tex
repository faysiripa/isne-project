...
time.sleep(10)
payload = str(random.randint(100,65536)) + ") This long BRD packet will also be received even though a wrong dst_id is specified"
print('[Sending]', payload)
...
\noindent This script demonstrates:
\begin{itemize}
